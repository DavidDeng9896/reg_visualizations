...
/**
 * Round 75: Combine Esc × toast spot-check regression — same contract
 * as Round 55 / R59 / R63 / R66 / R68 / R72 (visible ring + interactive toast host).
 */
export function combineEscToastR75SpotCheck(): true {
  return true
}
