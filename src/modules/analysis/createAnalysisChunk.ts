 ...
 *
 * Round 43 / 45 / 46 / 48 / 50 / 52 / 54 / 56 re-eval: Create cold path still
 * async-idle-warm (1.5s). Eager sync would inflate list first paint for a
 * rarely opened dialog — keep deferred.
 */
