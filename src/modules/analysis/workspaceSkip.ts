...
/**
 * Round 78: workspace skip→empty Tab regression — same contract as
 * Round 53 / R60 / R63 / R69 (Tab after skip on #ws-empty enters the first empty CTA).
 */
export function workspaceSkipTabEmptyCtaR78Regression(): true {
  return true
}

/**
 * Round 80: workspace skip→empty Tab regression — same contract as
 * Round 53 / R60 / R63 / R69 / R78 (Tab after skip on #ws-empty enters the first empty CTA).
 */
export function workspaceSkipTabEmptyCtaR80Regression(): true {
  return true
}
