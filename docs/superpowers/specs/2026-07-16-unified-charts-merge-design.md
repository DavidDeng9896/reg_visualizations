...
| 项 | 结论 |
| --- | --- |
| 产出形态 | 新建 `doc/product/features/unified-charts/` |
...
1. 写出 [`conflicts.md`](../../../doc/product/features/unified-charts/conflicts.md) 供拍板  
2. 用户勾选确认后，按决议写齐 unified-charts 各细则  
...
```text
doc/product/features/unified-charts/
  README.md
  common.md
  bar-charts.md
  box-plots.md
...
- 开发只依赖 `unified-charts/` + 更新后的 `table-chart-integration.md`  
