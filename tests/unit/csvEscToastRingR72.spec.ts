...
describe('CSV Esc × toast spot-check (Round 72)', () => {
  afterEach(() => {
  ...
  it('documents Round 72 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR72SpotCheck()).toBe(true)
