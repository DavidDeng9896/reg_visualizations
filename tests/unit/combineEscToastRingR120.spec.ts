...
describe('Combine Esc × toast spot-check (Round 120)', () => {
  afterEach(() => {
  ...
  it('documents Round 120 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR120SpotCheck()).toBe(true)
