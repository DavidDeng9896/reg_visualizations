...
describe('CSV Esc × toast spot-check (Round 100)', () => {
  afterEach(() => {
  ...
  it('documents Round 100 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR100SpotCheck()).toBe(true)
