...
import {
  ...
  transformCancelToastR85SpotCheck,
...
describe('Transform Cancel × toast spot-check (Round 85)', () => {
  afterEach(() => {
  ...
  it('documents Round 85 Transform Cancel × toast spot-check regression', () => {
    expect(transformCancelToastR85SpotCheck()).toBe(true)
