...
import {
  ...
  newViewCancelToastR107Regression,
...
describe('New view Cancel × toast regression (Round 107)', () => {
  afterEach(() => {
  ...
  it('documents Round 107 New view Cancel × toast regression', () => {
    expect(newViewCancelToastR107Regression()).toBe(true)
