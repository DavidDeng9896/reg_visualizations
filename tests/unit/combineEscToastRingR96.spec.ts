...
describe('Combine Esc × toast spot-check (Round 96)', () => {
  afterEach(() => {
  ...
  it('documents Round 96 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR96SpotCheck()).toBe(true)
