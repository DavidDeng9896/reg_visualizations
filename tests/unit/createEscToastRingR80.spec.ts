...
describe('Create Esc × toast spot-check (Round 80)', () => {
  afterEach(() => {
  ...
  it('documents Round 80 Create Esc × toast spot-check regression', () => {
    expect(createEscToastR80SpotCheck()).toBe(true)
