...
import {
  ...
  workspaceSkipTabEmptyCtaR72Regression,
  workspaceSkipTabEntersEmptyCta,
} from '@/modules/analysis/workspaceSkip'

describe('workspace skip → Tab empty CTA regression (Round 72)', () => {
  afterEach(() => {
    document.body.innerHTML = ''
  })

  it('documents Round 72 workspace skip→empty Tab regression', () => {
    expect(workspaceSkipTabEmptyCtaR72Regression()).toBe(true)
