...
import {
  ...
  chartEditEscToastR101SpotCheck,
...
describe('ChartEdit Esc × toast spot-check (Round 101)', () => {
  afterEach(() => {
  ...
  it('documents Round 101 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR101SpotCheck()).toBe(true)
