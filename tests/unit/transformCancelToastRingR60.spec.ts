...
import {
  ...
  transformCancelToastR60SpotCheck,
...
describe('Transform Cancel × toast spot-check (Round 60)', () => {
  afterEach(() => {
  ...
  it('documents Round 60 Transform Cancel × toast spot-check regression', () => {
    expect(transformCancelToastR60SpotCheck()).toBe(true)
