...
import {
  ...
  transformCancelToastR95SpotCheck,
...
describe('Transform Cancel × toast spot-check (Round 95)', () => {
  afterEach(() => {
  ...
  it('documents Round 95 Transform Cancel × toast spot-check regression', () => {
    expect(transformCancelToastR95SpotCheck()).toBe(true)
