...
describe('CSV Esc × toast spot-check (Round 78)', () => {
  afterEach(() => {
  ...
  it('documents Round 78 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR78SpotCheck()).toBe(true)
