...
import {
  ...
  chartEditEscToastR123SpotCheck,
...
describe('ChartEdit Esc × toast spot-check (Round 123)', () => {
  afterEach(() => {
  ...
  it('documents Round 123 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR123SpotCheck()).toBe(true)
