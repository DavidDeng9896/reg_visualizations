...
import {
  ...
  newViewCancelToastR76Regression,
...
describe('New view Cancel × toast regression (Round 76)', () => {
  afterEach(() => {
  ...
  it('documents Round 76 New view Cancel × toast regression', () => {
    expect(newViewCancelToastR76Regression()).toBe(true)
