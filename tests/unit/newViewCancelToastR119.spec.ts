...
import {
  ...
  newViewCancelToastR119Regression,
...
describe('New view Cancel × toast regression (Round 119)', () => {
  afterEach(() => {
  ...
  it('documents Round 119 New view Cancel × toast regression', () => {
    expect(newViewCancelToastR119Regression()).toBe(true)
