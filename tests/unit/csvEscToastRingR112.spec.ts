...
describe('CSV Esc × toast spot-check (Round 112)', () => {
  afterEach(() => {
  ...
  it('documents Round 112 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR112SpotCheck()).toBe(true)
