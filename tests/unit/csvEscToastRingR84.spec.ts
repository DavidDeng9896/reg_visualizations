...
describe('CSV Esc × toast spot-check (Round 84)', () => {
  afterEach(() => {
  ...
  it('documents Round 84 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR84SpotCheck()).toBe(true)
