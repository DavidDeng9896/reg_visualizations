...
import {
  ...
  newViewCancelToastR113Regression,
...
describe('New view Cancel × toast regression (Round 113)', () => {
  afterEach(() => {
  ...
  it('documents Round 113 New view Cancel × toast regression', () => {
    expect(newViewCancelToastR113Regression()).toBe(true)
