...
import {
  ...
  transformCancelToastR97SpotCheck,
...
describe('Transform Cancel × toast spot-check (Round 97)', () => {
  afterEach(() => {
  ...
  it('documents Round 97 Transform Cancel × toast spot-check regression', () => {
    expect(transformCancelToastR97SpotCheck()).toBe(true)
