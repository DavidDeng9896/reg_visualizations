...
import {
  ...
  transformCancelToastR119SpotCheck,
...
describe('Transform Cancel × toast spot-check (Round 119)', () => {
  afterEach(() => {
  ...
  it('documents Round 119 Transform Cancel × toast spot-check regression', () => {
    expect(transformCancelToastR119SpotCheck()).toBe(true)
