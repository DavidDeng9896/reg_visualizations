...
import {
  ...
  transformCancelToastR87SpotCheck,
...
describe('Transform Cancel × toast spot-check (Round 87)', () => {
  afterEach(() => {
  ...
  it('documents Round 87 Transform Cancel × toast spot-check regression', () => {
    expect(transformCancelToastR87SpotCheck()).toBe(true)
