...
describe('ChartEdit Esc × toast spot-check (Round 64)', () => {
  afterEach(() => {
  ...
  it('documents Round 64 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR64SpotCheck()).toBe(true)
