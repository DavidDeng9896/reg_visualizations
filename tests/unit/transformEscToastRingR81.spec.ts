...
describe('Transform Esc × toast spot-check (Round 81)', () => {
  afterEach(() => {
  ...
  it('documents Round 81 Transform Esc × toast spot-check regression', () => {
    expect(transformEscToastR81SpotCheck()).toBe(true)
