...
import {
  ...
  transformCancelToastR105SpotCheck,
...
describe('Transform Cancel × toast spot-check (Round 105)', () => {
  afterEach(() => {
  ...
  it('documents Round 105 Transform Cancel × toast spot-check regression', () => {
    expect(transformCancelToastR105SpotCheck()).toBe(true)
