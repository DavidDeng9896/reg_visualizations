...
describe('ChartEdit Esc × toast spot-check (Round 99)', () => {
  afterEach(() => {
  ...
  it('documents Round 99 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR99SpotCheck()).toBe(true)
