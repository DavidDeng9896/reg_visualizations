...
describe('Combine Esc × toast spot-check (Round 114)', () => {
  afterEach(() => {
  ...
  it('documents Round 114 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR114SpotCheck()).toBe(true)
