...
describe('Combine Esc × toast spot-check (Round 84)', () => {
  afterEach(() => {
  ...
  it('documents Round 84 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR84SpotCheck()).toBe(true)
