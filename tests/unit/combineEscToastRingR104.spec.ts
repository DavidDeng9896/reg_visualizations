...
describe('Combine Esc × toast spot-check (Round 104)', () => {
  afterEach(() => {
  ...
  it('documents Round 104 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR104SpotCheck()).toBe(true)
