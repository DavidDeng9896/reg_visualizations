...
import {
  ...
  transformCancelToastR103SpotCheck,
...
describe('Transform Cancel × toast spot-check (Round 103)', () => {
  afterEach(() => {
  ...
  it('documents Round 103 Transform Cancel × toast spot-check regression', () => {
    expect(transformCancelToastR103SpotCheck()).toBe(true)
