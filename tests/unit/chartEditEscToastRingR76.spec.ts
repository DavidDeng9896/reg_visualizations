...
describe('ChartEdit Esc × toast spot-check (Round 76)', () => {
  afterEach(() => {
  ...
  it('documents Round 76 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR76SpotCheck()).toBe(true)
