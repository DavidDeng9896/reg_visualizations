...
import {
  ...
  chartEditEscToastR117SpotCheck,
...
describe('ChartEdit Esc × toast spot-check (Round 117)', () => {
  afterEach(() => {
  ...
  it('documents Round 117 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR117SpotCheck()).toBe(true)
