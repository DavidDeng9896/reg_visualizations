...
describe('Combine Esc × toast spot-check (Round 63)', () => {
  afterEach(() => {
  ...
  it('documents Round 63 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR63SpotCheck()).toBe(true)
