...
import {
  ...
  workspaceSkipTabEmptyCtaR60Regression,
  workspaceSkipTabEntersEmptyCta,
} from '@/modules/analysis/workspaceSkip'

describe('workspace skip → Tab empty CTA regression (Round 60)', () => {
  afterEach(() => {
    document.body.innerHTML = ''
  })

  it('documents Round 60 workspace skip→empty Tab regression', () => {
    expect(workspaceSkipTabEmptyCtaR60Regression()).toBe(true)
