...
import {
  ...
  transformCancelToastR83SpotCheck,
...
describe('Transform Cancel × toast spot-check (Round 83)', () => {
  afterEach(() => {
  ...
  it('documents Round 83 Transform Cancel × toast spot-check regression', () => {
    expect(transformCancelToastR83SpotCheck()).toBe(true)
