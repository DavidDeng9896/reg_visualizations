...
import {
  ...
  transformCancelToastR115SpotCheck,
...
describe('Transform Cancel × toast spot-check (Round 115)', () => {
  afterEach(() => {
  ...
  it('documents Round 115 Transform Cancel × toast spot-check regression', () => {
    expect(transformCancelToastR115SpotCheck()).toBe(true)
