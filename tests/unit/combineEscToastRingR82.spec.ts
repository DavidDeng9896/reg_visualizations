...
describe('Combine Esc × toast spot-check (Round 82)', () => {
  afterEach(() => {
  ...
  it('documents Round 82 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR82SpotCheck()).toBe(true)
