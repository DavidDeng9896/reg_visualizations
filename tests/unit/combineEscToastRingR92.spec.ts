...
describe('Combine Esc × toast spot-check (Round 92)', () => {
  afterEach(() => {
  ...
  it('documents Round 92 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR92SpotCheck()).toBe(true)
