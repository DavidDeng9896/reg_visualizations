...
describe('CSV Esc × toast spot-check (Round 122)', () => {
  afterEach(() => {
  ...
  it('documents Round 122 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR122SpotCheck()).toBe(true)
