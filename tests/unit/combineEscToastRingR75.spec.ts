...
describe('Combine Esc × toast spot-check (Round 75)', () => {
  afterEach(() => {
  ...
  it('documents Round 75 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR75SpotCheck()).toBe(true)
