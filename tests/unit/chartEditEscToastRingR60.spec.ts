...
describe('ChartEdit Esc × toast spot-check (Round 60)', () => {
  afterEach(() => {
  ...
  it('documents Round 60 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR60SpotCheck()).toBe(true)
