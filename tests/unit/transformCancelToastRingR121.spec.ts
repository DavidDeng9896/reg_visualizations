...
import {
  ...
  transformCancelToastR121SpotCheck,
...
describe('Transform Cancel × toast spot-check (Round 121)', () => {
  afterEach(() => {
  ...
  it('documents Round 121 Transform Cancel × toast spot-check regression', () => {
    expect(transformCancelToastR121SpotCheck()).toBe(true)
