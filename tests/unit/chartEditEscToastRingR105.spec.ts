...
import {
  ...
  chartEditEscToastR105SpotCheck,
...
describe('ChartEdit Esc × toast spot-check (Round 105)', () => {
  afterEach(() => {
  ...
  it('documents Round 105 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR105SpotCheck()).toBe(true)
