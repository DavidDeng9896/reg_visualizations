...
describe('CSV Esc × toast spot-check (Round 59)', () => {
  afterEach(() => {
  ...
  it('documents Round 59 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR59SpotCheck()).toBe(true)
