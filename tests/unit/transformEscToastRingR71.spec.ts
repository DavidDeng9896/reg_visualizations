...
describe('Transform Esc × toast spot-check (Round 71)', () => {
  afterEach(() => {
  ...
  it('documents Round 71 Transform Esc × toast spot-check regression', () => {
    expect(transformEscToastR71SpotCheck()).toBe(true)
