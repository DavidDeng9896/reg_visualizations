...
describe('CSV Esc × toast spot-check (Round 114)', () => {
  afterEach(() => {
  ...
  it('documents Round 114 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR114SpotCheck()).toBe(true)
