...
describe('Combine Esc × toast spot-check (Round 98)', () => {
  afterEach(() => {
  ...
  it('documents Round 98 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR98SpotCheck()).toBe(true)
