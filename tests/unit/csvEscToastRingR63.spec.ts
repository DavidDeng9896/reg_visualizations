...
describe('CSV Esc × toast spot-check (Round 63)', () => {
  afterEach(() => {
  ...
  it('documents Round 63 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR63SpotCheck()).toBe(true)
