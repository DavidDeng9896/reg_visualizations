...
describe('Transform Esc × toast spot-check (Round 67)', () => {
  afterEach(() => {
  ...
  it('documents Round 67 Transform Esc × toast spot-check regression', () => {
    expect(transformEscToastR67SpotCheck()).toBe(true)
