...
import {
  ...
  transformCancelToastR113SpotCheck,
...
describe('Transform Cancel × toast spot-check (Round 113)', () => {
  afterEach(() => {
  ...
  it('documents Round 113 Transform Cancel × toast spot-check regression', () => {
    expect(transformCancelToastR113SpotCheck()).toBe(true)
