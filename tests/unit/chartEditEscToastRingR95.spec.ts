...
describe('ChartEdit Esc × toast spot-check (Round 95)', () => {
  afterEach(() => {
  ...
  it('documents Round 95 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR95SpotCheck()).toBe(true)
