...
describe('Combine Esc × toast spot-check (Round 102)', () => {
  afterEach(() => {
  ...
  it('documents Round 102 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR102SpotCheck()).toBe(true)
