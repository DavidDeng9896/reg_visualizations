...
describe('Combine Esc × toast spot-check (Round 108)', () => {
  afterEach(() => {
  ...
  it('documents Round 108 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR108SpotCheck()).toBe(true)
