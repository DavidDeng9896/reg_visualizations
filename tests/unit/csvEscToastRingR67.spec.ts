...
describe('CSV Esc × toast spot-check (Round 67)', () => {
  afterEach(() => {
  ...
  it('documents Round 67 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR67SpotCheck()).toBe(true)
