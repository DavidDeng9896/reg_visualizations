...
describe('ChartEdit Esc × toast spot-check (Round 69)', () => {
  afterEach(() => {
  ...
  it('documents Round 69 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR69SpotCheck()).toBe(true)
