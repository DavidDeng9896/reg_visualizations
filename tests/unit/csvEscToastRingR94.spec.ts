...
describe('CSV Esc × toast spot-check (Round 94)', () => {
  afterEach(() => {
  ...
  it('documents Round 94 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR94SpotCheck()).toBe(true)
