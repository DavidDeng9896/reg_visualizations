...
import {
  ...
  chartEditEscToastR121SpotCheck,
...
describe('ChartEdit Esc × toast spot-check (Round 121)', () => {
  afterEach(() => {
  ...
  it('documents Round 121 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR121SpotCheck()).toBe(true)
