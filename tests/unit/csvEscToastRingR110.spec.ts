...
describe('CSV Esc × toast spot-check (Round 110)', () => {
  afterEach(() => {
  ...
  it('documents Round 110 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR110SpotCheck()).toBe(true)
