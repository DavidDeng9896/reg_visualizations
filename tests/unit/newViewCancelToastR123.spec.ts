...
import {
  ...
  newViewCancelToastR123Regression,
...
describe('New view Cancel × toast regression (Round 123)', () => {
  afterEach(() => {
  ...
  it('documents Round 123 New view Cancel × toast regression', () => {
    expect(newViewCancelToastR123Regression()).toBe(true)
