...
import {
  ...
  workspaceSkipTabEmptyCtaR63Regression,
  workspaceSkipTabEntersEmptyCta,
} from '@/modules/analysis/workspaceSkip'

describe('workspace skip → Tab empty CTA regression (Round 63)', () => {
  afterEach(() => {
    document.body.innerHTML = ''
  })

  it('documents Round 63 workspace skip→empty Tab regression', () => {
    expect(workspaceSkipTabEmptyCtaR63Regression()).toBe(true)
