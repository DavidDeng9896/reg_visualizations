...
import {
  ...
  newViewCancelToastR87Regression,
...
describe('New view Cancel × toast regression (Round 87)', () => {
  afterEach(() => {
  ...
  it('documents Round 87 New view Cancel × toast regression', () => {
    expect(newViewCancelToastR87Regression()).toBe(true)
