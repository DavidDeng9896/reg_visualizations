...
describe('Transform Esc × toast spot-check (Round 58)', () => {
  afterEach(() => {
  ...
  it('documents Round 58 Transform Esc × toast spot-check regression', () => {
    expect(transformEscToastR58SpotCheck()).toBe(true)
