...
import {
  ...
  transformCancelToastR107SpotCheck,
...
describe('Transform Cancel × toast spot-check (Round 107)', () => {
  afterEach(() => {
  ...
  it('documents Round 107 Transform Cancel × toast spot-check regression', () => {
    expect(transformCancelToastR107SpotCheck()).toBe(true)
