...
describe('CSV Cancel × toast spot-check (Round 65)', () => {
  afterEach(() => {
  ...
  it('documents Round 65 CSV Cancel × toast spot-check regression', () => {
    expect(csvCancelToastR65SpotCheck()).toBe(true)
