...
describe('ChartEdit Esc × toast spot-check (Round 97)', () => {
  afterEach(() => {
  ...
  it('documents Round 97 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR97SpotCheck()).toBe(true)
