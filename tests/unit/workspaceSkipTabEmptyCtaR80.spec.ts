...
import {
  ...
  workspaceSkipTabEmptyCtaR80Regression,
  workspaceSkipTabEntersEmptyCta,
} from '@/modules/analysis/workspaceSkip'

describe('workspace skip → Tab empty CTA regression (Round 80)', () => {
  afterEach(() => {
    document.body.innerHTML = ''
  })

  it('documents Round 80 workspace skip→empty Tab regression', () => {
    expect(workspaceSkipTabEmptyCtaR80Regression()).toBe(true)
