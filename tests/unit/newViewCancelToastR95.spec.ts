...
import {
  ...
  newViewCancelToastR95Regression,
...
describe('New view Cancel × toast regression (Round 95)', () => {
  afterEach(() => {
  ...
  it('documents Round 95 New view Cancel × toast regression', () => {
    expect(newViewCancelToastR95Regression()).toBe(true)
