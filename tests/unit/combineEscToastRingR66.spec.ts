...
describe('Combine Esc × toast spot-check (Round 66)', () => {
  afterEach(() => {
  ...
  it('documents Round 66 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR66SpotCheck()).toBe(true)
