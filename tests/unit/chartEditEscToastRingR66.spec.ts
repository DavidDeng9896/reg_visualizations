...
describe('ChartEdit Esc × toast spot-check (Round 66)', () => {
  afterEach(() => {
  ...
  it('documents Round 66 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR66SpotCheck()).toBe(true)
