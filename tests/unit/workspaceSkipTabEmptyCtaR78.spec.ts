...
import {
  ...
  workspaceSkipTabEmptyCtaR78Regression,
  workspaceSkipTabEntersEmptyCta,
} from '@/modules/analysis/workspaceSkip'

describe('workspace skip → Tab empty CTA regression (Round 78)', () => {
  afterEach(() => {
    document.body.innerHTML = ''
  })

  it('documents Round 78 workspace skip→empty Tab regression', () => {
    expect(workspaceSkipTabEmptyCtaR78Regression()).toBe(true)
