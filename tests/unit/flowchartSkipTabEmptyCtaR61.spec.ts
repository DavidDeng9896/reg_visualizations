...
import {
  flowchartSkipTabEmptyCtaR61Regression,
  flowchartSkipTabEntersEmptyCta,
} from '@/modules/flowchart/flowchartEmpty'

describe('flowchart skip → Tab empty CTA regression (Round 61)', () => {
  afterEach(() => {
    document.body.innerHTML = ''
  })

  it('documents Round 61 flowchart skip→empty Tab regression', () => {
    expect(flowchartSkipTabEmptyCtaR61Regression()).toBe(true)
