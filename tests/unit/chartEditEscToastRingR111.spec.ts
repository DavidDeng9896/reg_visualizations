...
import {
  ...
  chartEditEscToastR111SpotCheck,
...
describe('ChartEdit Esc × toast spot-check (Round 111)', () => {
  afterEach(() => {
  ...
  it('documents Round 111 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR111SpotCheck()).toBe(true)
