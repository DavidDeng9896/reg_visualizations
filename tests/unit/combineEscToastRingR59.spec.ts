...
describe('Combine Esc × toast spot-check (Round 59)', () => {
  afterEach(() => {
  ...
  it('documents Round 59 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR59SpotCheck()).toBe(true)
