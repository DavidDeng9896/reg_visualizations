...
describe('ChartEdit Esc × toast spot-check (Round 73)', () => {
  afterEach(() => {
  ...
  it('documents Round 73 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR73SpotCheck()).toBe(true)
