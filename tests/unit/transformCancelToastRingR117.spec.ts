...
import {
  ...
  transformCancelToastR117SpotCheck,
...
describe('Transform Cancel × toast spot-check (Round 117)', () => {
  afterEach(() => {
  ...
  it('documents Round 117 Transform Cancel × toast spot-check regression', () => {
    expect(transformCancelToastR117SpotCheck()).toBe(true)
