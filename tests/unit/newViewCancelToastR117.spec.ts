...
import {
  ...
  newViewCancelToastR117Regression,
...
describe('New view Cancel × toast regression (Round 117)', () => {
  afterEach(() => {
  ...
  it('documents Round 117 New view Cancel × toast regression', () => {
    expect(newViewCancelToastR117Regression()).toBe(true)
