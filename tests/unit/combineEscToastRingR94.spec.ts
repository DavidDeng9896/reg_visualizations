...
describe('Combine Esc × toast spot-check (Round 94)', () => {
  afterEach(() => {
  ...
  it('documents Round 94 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR94SpotCheck()).toBe(true)
