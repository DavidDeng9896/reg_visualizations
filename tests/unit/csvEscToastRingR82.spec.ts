...
describe('CSV Esc × toast spot-check (Round 82)', () => {
  afterEach(() => {
  ...
  it('documents Round 82 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR82SpotCheck()).toBe(true)
