...
describe('CSV Esc × toast spot-check (Round 98)', () => {
  afterEach(() => {
  ...
  it('documents Round 98 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR98SpotCheck()).toBe(true)
