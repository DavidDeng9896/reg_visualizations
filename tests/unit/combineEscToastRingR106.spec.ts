...
describe('Combine Esc × toast spot-check (Round 106)', () => {
  afterEach(() => {
  ...
  it('documents Round 106 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR106SpotCheck()).toBe(true)
