...
describe('Combine Esc × toast spot-check (Round 88)', () => {
  afterEach(() => {
  ...
  it('documents Round 88 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR88SpotCheck()).toBe(true)
