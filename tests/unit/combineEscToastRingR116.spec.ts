...
describe('Combine Esc × toast spot-check (Round 116)', () => {
  afterEach(() => {
  ...
  it('documents Round 116 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR116SpotCheck()).toBe(true)
