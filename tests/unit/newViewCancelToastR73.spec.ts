...
import {
  ...
  newViewCancelToastR73Regression,
...
describe('New view Cancel × toast regression (Round 73)', () => {
  afterEach(() => {
  ...
  it('documents Round 73 New view Cancel × toast regression', () => {
    expect(newViewCancelToastR73Regression()).toBe(true)
