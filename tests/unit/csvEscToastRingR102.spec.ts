...
describe('CSV Esc × toast spot-check (Round 102)', () => {
  afterEach(() => {
  ...
  it('documents Round 102 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR102SpotCheck()).toBe(true)
