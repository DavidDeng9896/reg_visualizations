...
describe('ChartEdit Esc × toast spot-check (Round 79)', () => {
  afterEach(() => {
  ...
  it('documents Round 79 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR79SpotCheck()).toBe(true)
