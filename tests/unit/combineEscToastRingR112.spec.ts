...
describe('Combine Esc × toast spot-check (Round 112)', () => {
  afterEach(() => {
  ...
  it('documents Round 112 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR112SpotCheck()).toBe(true)
