...
describe('CSV Esc × toast spot-check (Round 120)', () => {
  afterEach(() => {
  ...
  it('documents Round 120 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR120SpotCheck()).toBe(true)
