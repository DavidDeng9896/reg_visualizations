...
describe('Combine Esc × toast spot-check (Round 72)', () => {
  afterEach(() => {
  ...
  it('documents Round 72 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR72SpotCheck()).toBe(true)
