...
import {
  ...
  chartEditEscToastR103SpotCheck,
...
describe('ChartEdit Esc × toast spot-check (Round 103)', () => {
  afterEach(() => {
  ...
  it('documents Round 103 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR103SpotCheck()).toBe(true)
