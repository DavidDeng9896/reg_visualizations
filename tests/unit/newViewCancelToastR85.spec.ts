...
import {
  ...
  newViewCancelToastR85Regression,
...
describe('New view Cancel × toast regression (Round 85)', () => {
  afterEach(() => {
  ...
  it('documents Round 85 New view Cancel × toast regression', () => {
    expect(newViewCancelToastR85Regression()).toBe(true)
