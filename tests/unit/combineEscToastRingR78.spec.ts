...
describe('Combine Esc × toast spot-check (Round 78)', () => {
  afterEach(() => {
  ...
  it('documents Round 78 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR78SpotCheck()).toBe(true)
