...
describe('Combine Esc × toast spot-check (Round 122)', () => {
  afterEach(() => {
  ...
  it('documents Round 122 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR122SpotCheck()).toBe(true)
