...
describe('Combine Esc × toast spot-check (Round 86)', () => {
  afterEach(() => {
  ...
  it('documents Round 86 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR86SpotCheck()).toBe(true)
