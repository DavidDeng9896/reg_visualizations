...
describe('CSV Esc × toast spot-check (Round 75)', () => {
  afterEach(() => {
  ...
  it('documents Round 75 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR75SpotCheck()).toBe(true)
