...
describe('ChartEdit Esc × toast spot-check (Round 87)', () => {
  afterEach(() => {
  ...
  it('documents Round 87 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR87SpotCheck()).toBe(true)
