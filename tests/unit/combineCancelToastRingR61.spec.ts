...
import {
  ...
  combineCancelToastR61SpotCheck,
...
describe('Combine Cancel × toast spot-check (Round 61)', () => {
  afterEach(() => {
  ...
  it('documents Round 61 Combine Cancel × toast spot-check regression', () => {
    expect(combineCancelToastR61SpotCheck()).toBe(true)
