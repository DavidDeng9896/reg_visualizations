...
describe('CSV Esc × toast spot-check (Round 96)', () => {
  afterEach(() => {
  ...
  it('documents Round 96 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR96SpotCheck()).toBe(true)
