...
describe('CSV Esc × toast spot-check (Round 86)', () => {
  afterEach(() => {
  ...
  it('documents Round 86 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR86SpotCheck()).toBe(true)
