...
import {
  ...
  chartEditEscToastR115SpotCheck,
...
describe('ChartEdit Esc × toast spot-check (Round 115)', () => {
  afterEach(() => {
  ...
  it('documents Round 115 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR115SpotCheck()).toBe(true)
