...
import {
  ...
  workspaceSkipTabEmptyCtaR75Regression,
  workspaceSkipTabEntersEmptyCta,
} from '@/modules/analysis/workspaceSkip'

describe('workspace skip → Tab empty CTA regression (Round 75)', () => {
  afterEach(() => {
    document.body.innerHTML = ''
  })

  it('documents Round 75 workspace skip→empty Tab regression', () => {
    expect(workspaceSkipTabEmptyCtaR75Regression()).toBe(true)
