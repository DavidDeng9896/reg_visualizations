...
describe('CSV Esc × toast spot-check (Round 92)', () => {
  afterEach(() => {
  ...
  it('documents Round 92 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR92SpotCheck()).toBe(true)
