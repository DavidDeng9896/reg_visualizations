...
describe('CSV Esc × toast spot-check (Round 104)', () => {
  afterEach(() => {
  ...
  it('documents Round 104 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR104SpotCheck()).toBe(true)
