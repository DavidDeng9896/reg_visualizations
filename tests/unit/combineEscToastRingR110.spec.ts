...
describe('Combine Esc × toast spot-check (Round 110)', () => {
  afterEach(() => {
  ...
  it('documents Round 110 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR110SpotCheck()).toBe(true)
