...
import {
  ...
  newViewCancelToastR105Regression,
...
describe('New view Cancel × toast regression (Round 105)', () => {
  afterEach(() => {
  ...
  it('documents Round 105 New view Cancel × toast regression', () => {
    expect(newViewCancelToastR105Regression()).toBe(true)
