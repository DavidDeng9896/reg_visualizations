...
describe('Combine Esc × toast spot-check (Round 100)', () => {
  afterEach(() => {
  ...
  it('documents Round 100 Combine Esc × toast spot-check regression', () => {
    expect(combineEscToastR100SpotCheck()).toBe(true)
