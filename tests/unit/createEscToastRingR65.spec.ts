...
describe('Create Esc × toast spot-check (Round 65)', () => {
  afterEach(() => {
  ...
  it('documents Round 65 Create Esc × toast spot-check regression', () => {
    expect(createEscToastR65SpotCheck()).toBe(true)
