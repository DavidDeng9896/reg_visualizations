...
describe('CSV Esc × toast spot-check (Round 116)', () => {
  afterEach(() => {
  ...
  it('documents Round 116 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR116SpotCheck()).toBe(true)
