...
import {
  ...
  chartEditEscToastR107SpotCheck,
...
describe('ChartEdit Esc × toast spot-check (Round 107)', () => {
  afterEach(() => {
  ...
  it('documents Round 107 ChartEdit Esc × toast spot-check regression', () => {
    expect(chartEditEscToastR107SpotCheck()).toBe(true)
