...
describe('CSV Esc × toast spot-check (Round 118)', () => {
  afterEach(() => {
  ...
  it('documents Round 118 CSV Esc × toast spot-check regression', () => {
    expect(csvEscToastR118SpotCheck()).toBe(true)
